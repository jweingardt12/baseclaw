...
export const TOOL_DESCRIPTIONS: Record<string, string> = {
  ...
  yahoo_competitor_tracker: "Track rival managers' roster moves, flag category impact, detect sniped targets and threat levels",
  yahoo_watchlist: "Check all watched players for ownership changes, z-score movement, and status updates",
  yahoo_watchlist_add: "Add a player to your watchlist for persistent tracking of ownership, z-score, and news",
  yahoo_watchlist_remove: "Remove a player from your watchlist",
  yahoo_category_arms_race: "Category-by-category competitive position: rank, gap to rivals, who's gaining on you",
  yahoo_research_feed: "Unified intelligence feed: news, league transactions, trending pickups, prospect signals",
  ...
  yahoo_redzone: "Live matchup scoreboard with per-player weekly stats, remaining games, and starting lineups",
};
